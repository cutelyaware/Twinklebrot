 ...
 * The order of precidence is as follows: <code>
 *                   top
 *                   system
 *                   userprefs
 *                   vendorprops
...
public class PropertyManager extends Properties {
    private final static String PRODUCT_NAME = "twinklebrot"; // wants to be passed in but would need to be environment variable.
     ...
     * 
     * @param prop_url packedPoints to a property file
    ...
    public static String getUserPrefFile() {
        ...
        File dir = new File(System.getProperty("user.home") + File.separator + "twinklebrot");
        if(!dir.exists())
            dir.mkdir();
        String userdefault = new File(dir, PRODUCT_NAME + ".props").getAbsolutePath();
    ...
    public static int getInt(String key, int def) {
        try {
            String val = top.getProperty(key);
